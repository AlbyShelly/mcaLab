...
void main(){
 int ch;
 while(1){
   printf("\n1.See List 2.Insertion at Starting 3.Insertion at end 4.Insertion at any position \n5.Delete First Element 6.Delete Last Element 7.Delete Element at any position 8.Search\n9.Exit\n");
   printf("\nEnter Your Choice:\n");
   scanf("%d",&ch);
   switch(ch){
     case 1:traverse();
